	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" aria-controls="DTclient" placeholder="Search" class="form-control mrs" style="width: 250px;">') :
			  sSearchStr === "" ? '<input type="text" aria-controls="DTclient" placeholder="Search" class="form-control mrs" style="width: 250px;">' : '<label>' + sSearchStr + '</label>' + ' <input type="text" aria-controls="DTclient" placeholder="Search" class="form-control mrs" style="width: 250px;">';
			
			var nFilter = document.createElement( 'div' );
			nFilter.className = oSettings.oClasses.sFilter;
			nFilter.innerHTML = '<label class="mrx mlx"' + sSearchStr + '</label>';
