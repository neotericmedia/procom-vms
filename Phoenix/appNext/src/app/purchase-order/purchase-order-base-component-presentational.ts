...
// organization
import { IReadOnlyStorage } from './state/purchase-order.interface';
import { PurchaseOrderApiServiceLocator } from './purchase-order.api.service.locator';

export abstract class PurchaseOrderBaseComponentPresentational<T> extends BaseComponentOnDestroy implements OnChanges {
  ...
  constructor(constructorName: string) {
    ...
    this.codeValueService = PurchaseOrderApiServiceLocator.injector.get<CodeValueService>(CodeValueService, null);
    this.commonService = PurchaseOrderApiServiceLocator.injector.get<CommonService>(CommonService, null);
    this.customFieldService = PurchaseOrderApiServiceLocator.injector.get<CustomFieldService>(CustomFieldService, null);
