...
import { PhxDataTableConfiguration, PhxDataTableColumn, PhxDataTableSummaryItem, PhxDataTableSummaryType } from '../../common/model/index';
import { CommonService } from '../../common/index';
import { Router} from '@angular/router';

@Component({
  selector: 'app-compliance-document-declined-search',
  templateUrl: './compliance-document-declined-search.component.html',
  styleUrls: ['./compliance-document-declined-search.component.less']
})
export class ComplianceDocumentDeclinedSearchComponent implements OnInit {
