...
// document rule
import { IReadOnlyStorage } from './state/document-rule.interface';
import { DocumentRuleApiServiceLocator } from './document-rule.api.service.locator';

export abstract class DocumentRuleBaseComponentPresentational<T> extends BaseComponentOnDestroy implements OnChanges {
  ...
  constructor(constructorName: string) {
    ...
    this.commonListsObservableService = DocumentRuleApiServiceLocator.injector.get<CommonListsObservableService>(CommonListsObservableService, null);
    this.codeValueService = DocumentRuleApiServiceLocator.injector.get<CodeValueService>(CodeValueService, null);
    this.commonService = DocumentRuleApiServiceLocator.injector.get<CommonService>(CommonService, null);
    this.customFieldService = DocumentRuleApiServiceLocator.injector.get<CustomFieldService>(CustomFieldService, null);
    this.formBuilder = DocumentRuleApiServiceLocator.injector.get<FormBuilder>(FormBuilder, null);
