// SergeyM: we can not use original version untill we upgrade angular from 4 to 5
// its because of not supported 'FormHooks' under ang4
// https://github.com/no0x9d/ngx-strongly-typed-forms
// "ngx-strongly-typed-forms": "^0.9.0",
...
// export type Controls<T> = {[P in keyof T]: FormArray<T[P]> | FormGroup<T[P]> | FormControl<T[P]>};
