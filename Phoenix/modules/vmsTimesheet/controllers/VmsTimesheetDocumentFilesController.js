(function () {
    ...
    angular.module('phoenix.vms.controllers').controller('VmsTimesheetDocumentFilesController', VmsTimesheetDocumentFilesController);

    /** @ngInject */
    VmsTimesheetDocumentFilesController.$inject = ['$state', 'CodeValueService', 'DocumentApiService', 'VmsApiService', 'vmsTableParams', 'vmsNewTableState', 'mixinsFactory', 'NavigationService'];

    function VmsTimesheetDocumentFilesController($state, CodeValueService, DocumentApiService, VmsApiService, vmsTableParams, vmsNewTableState, mixinsFactory, NavigationService) {
