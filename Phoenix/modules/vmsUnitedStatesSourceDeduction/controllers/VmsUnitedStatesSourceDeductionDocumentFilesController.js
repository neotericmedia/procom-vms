(function () {
    ...
    angular.module('phoenix.vms.controllers').controller('VmsUnitedStatesSourceDeductionDocumentFilesController', VmsUnitedStatesSourceDeductionDocumentFilesController);

    /** @ngInject */
    VmsUnitedStatesSourceDeductionDocumentFilesController.$inject = ['$state', 'CodeValueService', 'DocumentApiService', 'VmsApiService', 'vmsTableParams', 'vmsNewTableState', 'mixinsFactory', 'NavigationService'];

    function VmsUnitedStatesSourceDeductionDocumentFilesController($state, CodeValueService, DocumentApiService, VmsApiService, vmsTableParams, vmsNewTableState, mixinsFactory, NavigationService) {
