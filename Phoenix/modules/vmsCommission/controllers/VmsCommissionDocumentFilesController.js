(function () {
    ...
    angular.module('phoenix.vms.controllers').controller('VmsCommissionDocumentFilesController', VmsCommissionDocumentFilesController);

    /** @ngInject */
    VmsCommissionDocumentFilesController.$inject = ['$state', 'CodeValueService', 'DocumentApiService', 'VmsApiService', 'vmsTableParams', 'vmsNewTableState', 'mixinsFactory'];

    function VmsCommissionDocumentFilesController($state, CodeValueService, DocumentApiService, VmsApiService, vmsTableParams, vmsNewTableState, mixinsFactory) {
