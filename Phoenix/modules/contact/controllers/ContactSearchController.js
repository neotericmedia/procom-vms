(function () {
    ...
    angular.module('phoenix.contact.controllers')
        .controller('ContactSearchController', ContactSearchController);

    /** @ngInject */
    ContactSearchController.$inject = ['$state', 'CodeValueService', 'contactService', 'contactsTableParams', 'mixinsFactory'];
    function ContactSearchController($state, CodeValueService, contactService, contactsTableParams, mixinsFactory) {
        var self = this;
        ...
        mixinsFactory.createTableSupportMixin(angular.extend({
            serviceMethod: contactService.searchContactsST
