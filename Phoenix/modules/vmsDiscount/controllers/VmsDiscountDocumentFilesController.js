(function () {
    ...
    angular.module('phoenix.vms.controllers').controller('VmsDiscountDocumentFilesController', VmsDiscountDocumentFilesController);

    /** @ngInject */
    VmsDiscountDocumentFilesController.$inject = ['$state', 'CodeValueService', 'DocumentApiService', 'VmsApiService', 'vmsTableParams', 'vmsNewTableState', 'mixinsFactory', 'NavigationService'];

    function VmsDiscountDocumentFilesController($state, CodeValueService, DocumentApiService, VmsApiService, vmsTableParams, vmsNewTableState, mixinsFactory, NavigationService) {
