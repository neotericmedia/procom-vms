...
(function (app, angular) {
    ...
    var controllerId = 'OrgDeclinedController';
    ...
    angular.module('phoenix.org.controllers').controller(controllerId, ['$scope', '$state', 'common', 'NavigationService', 'SmartTableService', 'OrgApiService', 'CodeValueService',
            function OrgDeclinedController($scope, $state, common, NavigationService, SmartTableService, OrgApiService, CodeValueService) {
                ...
                NavigationService.setTitle('Declined Organizations', ['icon icon-organization']);
                ...
                $scope.callServer = function (tableState) {
                    ...
                    var promise = OrgApiService.getListOrganizationsDeclined(oDataParams + '&' + SmartTableService.generateRequestObject(tableState).url()).then(
